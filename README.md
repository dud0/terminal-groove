...
TUI Save As defaults to `.projects/project.groove.json`; the directory is created on first save and is ignored by Git. Explicit project paths remain unchanged.
